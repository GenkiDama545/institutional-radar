...
- `engine.test.cjs` : tests de règles, scénarios, couverture, exclusion des swaps non pris en charge et conservation des découvertes au-delà de 150 analyses approfondies. Lancer `node engine.test.cjs` et `node --check app.js`.
