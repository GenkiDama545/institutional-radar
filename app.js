...
const APP_VERSION='V8.9.16-rc.1';
...
if('serviceWorker' in navigator)window.addEventListener('load',()=>navigator.serviceWorker.register('./sw.js?v=8.9.16-rc.1',{updateViaCache:'none'}).catch(console.warn));
