...
function backDetail(){stopScenarioUpdates();stopCandleStream();if(graphLiveTimer){clearInterval(graphLiveTimer);graphLiveTimer=null}if(scenarioMonitorTimer){clearInterval(scenarioMonitorTimer);scenarioMonitorTimer=null}$('deep').classList.add('hidden');$('detail').classList.remove('hidden')}
...
function backHome(){stopScenarioUpdates();stopGraphUpdates();$('deep').classList.add('hidden');$('detail').classList.add('hidden');$('home').classList.remove('hidden')}
