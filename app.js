...
if('serviceWorker' in navigator)window.addEventListener('load',()=>navigator.serviceWorker.register('./sw.js?v=8.9.17',{updateViaCache:'none'}).catch(console.warn));
