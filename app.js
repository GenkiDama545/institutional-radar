...
if('serviceWorker' in navigator)window.addEventListener('load',()=>navigator.serviceWorker.register('./sw.js?v=8.9.6',{updateViaCache:'none'}).catch(console.warn));
