...
async function scenarioHtml(){
 ...
 ${e.longSetup&&scenarioValid('breakout',e.breakout,e.live)?scenarioCard('Cassure conditionnelle','🟢',e.breakout,'long',`clôture de ${e.triggerKey} au-dessus de ${axisPrice(e.breakout.entry)} avec volume ≥1,15× et biais compatible.`,breakoutNext,breakoutWhy,'breakout'):''}
 ${e.longSetup&&scenarioValid('pullback',e.pullback,e.live)?scenarioCard('Rebond sur support','🟡',e.pullback,'long',`prix et clôture ${e.triggerKey} au-dessus de ${axisPrice(e.pullback.entry)}, volume ≥1,15× et biais compatible.`,pullNext,pullWhy,'pullback'):''}
 ${isListedXperp(current.perpId)&&e.shortSetup&&e.rejectionValid?scenarioCard('Rejet conditionnel de résistance','🟠',e.shortRejection,'short',`prix et clôture ${e.triggerKey} sous ${axisPrice(e.shortRejection.entry)}, volume ≥1,15× et motif vendeur compatible.`,`Prochaine clôture ${e.triggerKey} : vérifier rejet + reprise de pression vendeuse.`,shortWhy,'rejection'):''}
