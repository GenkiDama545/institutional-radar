const CACHE='institutional-radar-v8.9.2';
const ASSETS=['./','./index.html','./market-screen.js?v=8.9.2','./engine-core.js?v=8.9.2','./hosted-config.js?v=8.9.2','./hosted-feed.js?v=8.9.2','./app.js?v=8.9.2','./manifest.json','./icon-192.png','./icon-512.png'];
