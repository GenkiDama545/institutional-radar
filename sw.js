const CACHE='institutional-radar-v8.9.1';
const ASSETS=['./','./index.html','./market-screen.js?v=8.9.1','./engine-core.js?v=8.9.1','./app.js?v=8.9.1','./manifest.json','./icon-192.png','./icon-512.png'];
