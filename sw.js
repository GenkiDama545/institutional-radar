const CACHE='institutional-radar-v8.9.4';
const ASSETS=['./','./index.html','./market-screen.js?v=8.9.4','./engine-core.js?v=8.9.4','./hosted-config.js?v=8.9.4','./hosted-feed.js?v=8.9.4','./app.js?v=8.9.4','./manifest.json','./icon-192.png','./icon-512.png'];
