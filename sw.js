const CACHE='institutional-radar-v8.9.3';
const ASSETS=['./','./index.html','./market-screen.js?v=8.9.3','./engine-core.js?v=8.9.3','./hosted-config.js?v=8.9.3','./hosted-feed.js?v=8.9.3','./app.js?v=8.9.3','./manifest.json','./icon-192.png','./icon-512.png'];
