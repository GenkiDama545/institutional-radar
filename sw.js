const CACHE='institutional-radar-v8.9.7';
const ASSETS=['./','./index.html','./experience.css?v=8.9.7','./market-screen.js?v=8.9.7','./engine-core.js?v=8.9.7','./hosted-config.js?v=8.9.7','./hosted-feed.js?v=8.9.7','./app.js?v=8.9.7','./manifest.json','./icon-192.png','./icon-512.png'];
