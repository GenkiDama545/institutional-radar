const CACHE='institutional-radar-v8.9.6';
const ASSETS=['./','./index.html','./experience.css?v=8.9.6','./market-screen.js?v=8.9.6','./engine-core.js?v=8.9.6','./hosted-config.js?v=8.9.6','./hosted-feed.js?v=8.9.6','./app.js?v=8.9.6','./manifest.json','./icon-192.png','./icon-512.png'];
